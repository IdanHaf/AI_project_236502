...
# Based on the code from https://blogs.codingballad.com/unwrapping-the-view-transforming-360-panoramas-into-intuitive-videos-with-python-6009bd5bca94
...
def panorama_to_plane(panorama_path, FOV, output_size, yaw, pitch):
    ...
    output = Image.fromarray(colors.reshape((H, W, 3)).astype('uint8'), 'RGB')
    return output
