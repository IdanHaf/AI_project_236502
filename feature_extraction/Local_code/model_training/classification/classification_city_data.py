...
from feature_extraction.Local_code.customDatasets.city_custom_dataset import CustomImageDataset
...
torch.save(model.state_dict(), 'resnet50module_city_dataset_cls.pth')
print("Module saved")
